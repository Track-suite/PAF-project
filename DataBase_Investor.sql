...
-- Database: `mine`
--
CREATE DATABASE IF NOT EXISTS `mine` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `mine`;
...
('root', '[{\"db\":\"invest\",\"table\":\"investor\"},{\"db\":\"mine\",\"table\":\"testing\"},{\"db\":\"mine\",\"table\":\"test2\"}]');
...
('root', '2021-04-25 06:40:11', '{\"Console\\/Mode\":\"show\"}');
